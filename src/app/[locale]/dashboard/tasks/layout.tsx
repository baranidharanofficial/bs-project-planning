  ...
  return (
    <main className="relative w-full h-[90vh] flex items-center justify-between box-border">
      ...
      <div className="!w-[15%] h-full bg-white dark:bg-slate-900 p-4 rounded-sm">
        <Link href={"/dashboard"} className="w-[100%] flex items-center justify-start cursor-pointer mb-6">
          <MdArrowBackIos />
          <p className="text-md font-semibold text-slate-900 dark:text-white">Go to Projects</p>
        </Link>
      ...
      <div className="w-[85%] h-full pl-5 relative">
       {children}
      </div>
    </main>
  );
